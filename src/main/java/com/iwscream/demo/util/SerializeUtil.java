...
public class SerializeUtil {
     ...
     */
    private static final Class<POJOWrapper> WRAPPER_CLASS = POJOWrapper.class;

    /**
     * 序列化/反序列化包装类 Schema 对象
     */
    private static final Schema<POJOWrapper> WRAPPER_SCHEMA = RuntimeSchema.createFrom(WRAPPER_CLASS);
    ...
    public static <T> byte[] serialize(T obj) {
        ...
        try {
            ...
            if (!WRAPPER_SET.contains(clazz)) {
                ...
                serializeObject = POJOWrapper.builder(obj);
            }
